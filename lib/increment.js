...
export async function finish(filename) {
  ...
  // Clear active increment in context
...
export async function group(options = {}) {
  ...
  for (const child of children) {
    ...
    await writeFile(join(base, 'pending', cFilename), serializeFrontmatter(cFm, cBody))
  ...
  // Update context
  await updateContext(parentFilename, [])
