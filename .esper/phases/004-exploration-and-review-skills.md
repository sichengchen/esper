...
- Plan 025 — fix: stop plan #N references from triggering GitHub auto-linking: Replace #<id> with Plan <id> in PR bodies and plan <id> in commit messages. Files: SKILL.md (5), plan.js
