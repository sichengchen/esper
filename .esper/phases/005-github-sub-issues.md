...
- Plan 28 — Update plan-consumption skills for sub-issue lifecycle: Updated esper-ship and esper-backlog for sub-issue awareness; backlog displays gh_issue numbers. Files: SKILL.md (x2), backlog.js
